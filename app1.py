...
def initialize_qa_system():
    ...
    #     google_api_key='AIzaSyBUz4Xw-c92Rtj0IRmpOxL2s5w-lP-3bw4',
    ...
    import os
    os.environ["PINECONE_API_KEY"] = "pcsk_6eMKMc_62E6WFQdjm9WN9wab4taDYh5UoPpwTSFPxaNaQRc64JpUTeCVxU8V8tYyvVN2bK"
    index_name = "langchain-text-index-gemini"


    # Create the vector store
    vectordb = Pinecone.from_documents(documents=texts, embedding=embeddings, index_name = index_name)
    #vctordb = Chroma.from_documents(documents=texts, embedding=embeddings)
